...
4) Suppose a DLP is eligible for 10,000 VANA in DLP incentives at the close of Epoch 6. 
   ...
   - The DLP incentives allocated to a DLP in Epoch 6 will be deployed linearly throughout Epoch 7. Each day, the proportionate amount of rewards (1110 VANA) is used to buy the DLP’s token and add it to the DEX liquidity pool alongside an equal amount of VANA. 
